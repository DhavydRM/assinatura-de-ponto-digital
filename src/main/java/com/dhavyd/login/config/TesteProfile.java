...
public class TesteProfile implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Usuario us1 = new Usuario(null, "Dhavyd", "dhavyd@gmail.com", "Dhavyd009", null);
        Usuario us2 = new Usuario(null, "Ingrid", "ingrid@gmail.com", "Ingrid12@009", null);
        Usuario us3 = new Usuario(null, "Felipe", "felipe@gmail.com", "Coelho029@", null);
